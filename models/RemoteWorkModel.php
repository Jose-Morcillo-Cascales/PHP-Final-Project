...
class RemoteWorkModel extends Model {
    ...
    function create($member){
        ...
        try {
            ...
            //CREATION FACE_TO_FACE
             ...
             $newRemote=$this->database->connect()->
             prepare("INSERT INTO remote_work(id,city,street_address,from_date,to_date) 
             VALUES
    ...
    function update($member){
        ...
        prepare("UPDATE remote_work SET 
    ...
    function delete($id){
        ...
        $deleteRemoteWork =$this->database->connect()->
        prepare("DELETE FROM remote_work WHERE id=$id");
